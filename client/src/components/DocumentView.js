...
class DocumentView extends React.Component{
    render(){
        ...
        const text = ( <div><p>모든 국민의 재산권은 보장된다. 그 내용과 한계는 법률로 정한다. 훈장등의 영전은 이를 받은 자에게만 효력이 있고, 어떠한 특권도 이에 따르지 아니한다.</p>
            ...
            <p>국민경제의 발전을 위한 중요정책의 수립에 관하여 대통령의 자문에 응하기 위하여 국민경제자문회의를 둘 수 있다. 대통령의 선거에 관한 사항은 법률로 정한다.</p></div>
            );
        return(
            <div>
